  ...
  return [
    {
      ...
      lastSyncAt: now,
      highlights: [
        "Insights prompt now includes normalized integration summaries",
      ],
    },
    {
      id: "spotify",
    ...
    },
    {
      ...
      description:
        "Planned native integration for a more holistic time-spent model across apps and categories.",
      status: "planned",
      source: "device",
      platform: "ios",
      nextStep:
        "Add a native iOS module using FamilyControls + DeviceActivity in an Expo development build.",
      highlights: [
