...
export default function TodayPage() {
  ...
  const trendData = [...recentLogs]
    ...
    .map((l) => ({
      day: new Date(`${l.date}T12:00:00`).toLocaleDateString("en-US", {
        weekday: "short",
      }),
        ...
        <GradientCard>
          ...
          <div className="grid grid-cols-2 gap-y-2 text-sm">
            ...
            <div className="text-text font-medium capitalize">
              {log.caffeine.type}
              {log.caffeine.amount > 0 ? ` · ${log.caffeine.amount}mg` : ""}
            </div>
      ...
      {!log && (
        <GradientCard>
          <p className="text-sm text-text-secondary text-center py-4">
            ...
            <span className="text-accent">Log</span> to record your day.
          </p>
        </GradientCard>
      )}
    </div>
