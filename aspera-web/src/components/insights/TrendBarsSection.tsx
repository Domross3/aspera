...
export function TrendBarsSection({ trends }: TrendBarsSectionProps) {
  ...
  return (
    <div className="space-y-2">
      <h3 className="text-xs font-bold uppercase tracking-widest text-text-muted">Weekly Trends</h3>
      <div className="h-40">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={data} barGap={2} barSize={8}>
            ...
            <YAxis tick={{ fill: "#9BA8C4", fontSize: 11 }} axisLine={false} tickLine={false} domain={[0, 10]} />
            <Tooltip
