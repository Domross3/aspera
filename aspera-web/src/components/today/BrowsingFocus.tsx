...
interface BrowsingData {
  ...
  sites: Record<
    string,
    { time: number; category: string; visits: number; hostname: string }
  >;
...
export function BrowsingFocus() {
  ...
  const totalMs =
    data.totals.productive + data.totals.neutral + data.totals.distracting;
