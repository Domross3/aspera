(() => {
  ...
  ((e.id = 974),
    ...
    (e.modules = {
        ...
        let d = [
            "",
            {
              children: [
                ...
                {
                  page: [
                    () => Promise.resolve().then(r.bind(r, 42177)),
                    "/Users/dominicross/Documents/EECS/CBCHackathon/aspera-web/app/page.tsx",
                  ],
                },
              ],
            },
            {
              layout: [
                () => Promise.resolve().then(r.bind(r, 58014)),
      ...
      58014: (e, t, r) => {
        "use strict";
        (r.r(t), r.d(t, { default: () => i, metadata: () => o }));
        var n = r(37413);
        r(82704);
        let o = {
