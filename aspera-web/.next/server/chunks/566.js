  ...
  (exports.modules = {
    ...
    96566: (t, e, r) => {
      ...
      class u {
        ...
        async *stream() {
          let { mtimeMs: t } = await s.promises.stat(h(this, i, "f"));
      ...
      async function p(t, e, r) {
        let i = await s.promises.stat(t);
        return (function (t, { mtimeMs: e, size: r }, i, o = {}) {
          let s;
          d(i) ? ([o, s] = [i, void 0]) : (s = i);
          let a = new u({ path: t, size: r, lastModified: e });
          return (
            s || (s = a.name),
            new c.Z([a], s, { ...o, lastModified: a.lastModified })
          );
        })(t, i, e, r);
      }
    },
